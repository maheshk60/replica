...
from .models import (
    ...
    LegalCaseAuditLog,CourtCase, CourtCaseStatusLog, ReviewRequest,CaseNotice,
    NoticeDocument, NoticeReply,CaseClosureDocument,
)
...
class CaseNoticeViewSet(viewsets.ModelViewSet):
    ...
    def submit_docs(self, request, pk=None):
        ...
        # Collect what actually became pending in this submit
        ...
        # Skip logging if nothing meaningful in this submit
...
class NoticeReplyViewSet(viewsets.ModelViewSet):
    ...
    def send_for_review(self, request, pk=None):
        ...
        # ✅ Log one card for this HTML reply submission (with any sup docs linked to it)
        sup_names = list(
            NoticeDocument.objects.filter(
                notice=reply.notice,
